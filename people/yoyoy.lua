    ...
    function library:window(properties)
        ...
        local items = cfg.items; do
            ...
            items[ "other_info" ] = library:create( "TextLabel" , {
                ...
                TextColor3 = themes.preset.accent;
                BorderColor3 = rgb(0, 0, 0);
                Text = '<font color="rgb(72, 72, 73)"> Developer Build | </font>' .. cfg.name .. cfg.suffix;
                Size = dim2(1, 0, 0, 0);
                Position = dim2(0, -10, 0.5, -1);
                AnchorPoint = vec2(0, 0.5);
                BorderSizePixel = 0;
    ...
    function library:init_config(window) 
        ...
        section:button({
            ...
            callback = function()
                ...
                if success then
                    sendNotification("Honey", "Opened Config Folder: " .. folderPath)
                else
                    sendNotification("Honey", executorName .. " does not support opening folders")
                end
            end
        })
